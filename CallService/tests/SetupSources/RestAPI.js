console.log('AWS Lambda function StateFunction for US State sample web service');
// Lambda Function: StateFunction
//
//
// DEV POST endpoint https://rmwum5l4zc.execute-api.us-east-1.amazonaws.com/dev/stateresource
...
exports.handler = function(event,context) {
    ...
    var usstate  = (event.usstate  === undefined ? 'Massachusetts' : event.usstate);
    ...
    var dataset =
        ...
        for (i = 0; i < dataset.length; i++) {
                if(dataset[i].Name === usstate) {
                        console.log("Found a match!  " + usstate);
    ...
    context.done(null, {"usstate":usstate, "attributes": [{"population": pop}, {"rank": rank}] } );  // SUCCESS with message
}
